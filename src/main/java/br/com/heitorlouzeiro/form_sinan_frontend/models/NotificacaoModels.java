package br.com.heitorlouzeiro.form_sinan_frontend.models;
...
public class NotificacaoModels {
    ...
    public Integer getAgravoDoenca() {
        return agravoDoenca;
    }

    public void setAgravoDoenca(Integer agravoDoenca) {
